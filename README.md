...
RD is the database software itself sql is the languged used to query it.

2. Why do tables need a `primary key`?

so each entry has a unique identifier for data manipulation.
...
a join tabe that has the primary key of the joining tables
